...
func startWorkerPool(ctx context.Context, cfg Config, jobs <-chan Job, wg *sync.WaitGroup){
...
func processJob(logger *slog.Logger, job Job) {
...
func main() {
	...
	startWorkerPool(ctx, cfg, jobQueue, &wg)
